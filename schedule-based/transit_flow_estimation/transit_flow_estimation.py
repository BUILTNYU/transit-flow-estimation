...
from dynamic_schedule_based_ue_assignment_algorithm_run import dynamic_schedule_based_ue_assignment_algorithm_run
from dynamic_schedule_based_ue_model_run import dynamic_schedule_based_ue_model_run
...
if algorithm_selection == 1:
	dynamic_schedule_based_ue_assignment_algorithm_run()
elif algorithm_selection == 2:
	dynamic_schedule_based_ue_model_run()
